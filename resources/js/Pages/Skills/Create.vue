<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight text-center">New Skill</h2>
        </template>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <form @submit.prevent="submit" class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div class="flex justify-center">
                        <PrimaryButton type="submit" class="max-w-xs py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue">Create Skill</PrimaryButton>
                    </div>
                </form>
            </div>
        </div>
